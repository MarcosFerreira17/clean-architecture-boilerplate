...
namespace Template.Presentation.Configurations.Extensions;

public static class PresentationExtensions
{
    public static IHost MigrateDatabase<TContext>(this IHost Presentation) where TContext : TemplateDbContext
    {
        using (var scope = Presentation.Services.CreateScope())
        {
