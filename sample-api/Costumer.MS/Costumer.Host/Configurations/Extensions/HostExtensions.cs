...
namespace Costumer.Host.Configurations.Extensions;

public static class HostExtensions
{
    public static IHost MigrateDatabase<TContext>(this IHost host) where TContext : CostumerDbContext
    {
    ...
    private static void InvokeSeeder<TContext>(TContext context)
        where TContext : CostumerDbContext => context.Database.Migrate();
}