...
using Template.Tests.Helpers.Factories;
using Template.Tests.Helpers.MockData;

namespace Template.Tests.Infrastructure.Repositories;
...
public class TemplateRepositoryTests
{
    ...
    {
        //Arange
        _context.Template.AddRange(TemplateMockData.GetAllTemplate());
        _context.SaveChanges();
        //Act
        var result = await _repository.FindAll();
        //Assert
        result.Should().HaveCount(TemplateMockData.GetAllTemplate().Count);
    }
    ...
    public void GetByConditionSuccess()
    {
        ...
        _context.SaveChanges();
        //Act
        var findByIdMock = TemplateMockData.GetAllTemplate().Find(x => x.ExampleString == "Need To Test this proj").ExampleString;
    ...
    {
        //Arange
        await _repository.Create(TemplateMockData.NewTemplate());
        //Act
